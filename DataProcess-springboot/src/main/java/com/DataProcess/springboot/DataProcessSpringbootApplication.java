...
public class DataProcessSpringbootApplication {
    ...
    public static void main(String[] args){
        ...
        System.out.println("这是加密后的url"+textEncryptor.encrypt("jdbc:mysql://localhost:3306/DataProcess?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8" ));
        System.out.println("这是加密后的用户名"+textEncryptor.encrypt("root"));
        System.out.println("这是加密后的密码"+textEncryptor.encrypt("14vs30basketball"));
